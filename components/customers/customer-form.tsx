        ...
        <Card padding="lg">
          <Form>
            ...
            >
              ...
              <FormRow>
                <FormField label="Phone" required hint="10-digit mobile">
                  <Input value={form.phone} onChange={(e) => set("phone", e.target.value)} required />
                </FormField>
                <FormField label="Alternate phone" hint="Optional">
          ...
          <Form>
            ...
            >
              ...
              <FormRow>
                ...
                <FormField label="Pincode" hint="6 digits">
                  <Input value={form.pincode} onChange={(e) => set("pincode", e.target.value)} maxLength={6} />
                </FormField>
              </FormRow>
              <FormField label="State" required>
                <Select value={form.state} onChange={(e) => set("state", e.target.value)} containerClassName="w-full" required>
              ...
              <FormRow>
                ...
                <FormField label="Aadhaar last 4" hint="Last 4 digits only">
                  <Input value={form.aadhaar_last4} onChange={(e) => set("aadhaar_last4", e.target.value)} maxLength={4} />
                </FormField>
              </FormRow>
            </FormSection>
            <FormActions>
        ...
        <Card padding="lg">
          <Form>
            ...
            <FormActions>
              ...
              {!customerId && (
                <Button type="button" variant="ghost" disabled={loading} onClick={() => save(true)}>
                  Save and add policy
                </Button>
              )}
            </FormActions>
